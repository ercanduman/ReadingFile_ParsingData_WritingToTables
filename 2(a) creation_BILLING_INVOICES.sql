...
comment on column EDUMAN.BILLING_INVOICES.Remark is 'Remark attribute defines the remark value of operation result can be Execution SUCCESSFUL! or Execution FAILED!.';
